...
public class Kaltura {
	 ...
	 * @param entryId id del capitulo que se traera la informacion
 	 */
	public void getChapter(String entryId){
		ProgrammingInfoAnsyncTask getInfoMedia = new ProgrammingInfoAnsyncTask(entryId);
	 ...
	 * @param textHeart textview al que se modificara su valor
 	 */
	public void setLikeChapter(String entryId,TextView textHeart){
		LikeAsyncTask likeAsyncTask = new LikeAsyncTask(entryId,textHeart);
