...
public class ProgrammingFragment extends Fragment {
	...
	public static ProgrammingFragment self;//contexto
	...
	//lo mio
	public static List<String> categoria = new ArrayList<String>();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Log.d("sweden", "TYppo: " + programType);
		...
		TextView textSlogan = (TextView)rootView.findViewById(R.id.programming_slogan);
...
//			listProgram.setListProgram(listP);
	 ...
	 *  @param string TRUE si esta en esta vista o FALSE si no esta en esta vista
	 */
