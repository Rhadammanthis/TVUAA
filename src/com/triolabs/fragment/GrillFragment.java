...
public class GrillFragment extends Fragment implements OnClickListener{
	...
	ArrayList<String> programMonday;
	ArrayList<String> programThursday;
	ArrayList<String> programWednesday;
	ArrayList<String> programTuesday;
	ArrayList<String> programFriday;
	ArrayList<String> programSaturday;
	ArrayList<String> programSunday;
	ArrayList<String> programFridayHour;;
	...
	static GrillFragment self;// contexto
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		programMonday=new ArrayList<String>();
		programThursday=new ArrayList<String>();
		programWednesday=new ArrayList<String>();
		programTuesday=new ArrayList<String>();
		programFriday=new ArrayList<String>();
		programSaturday=new ArrayList<String>();
		programSunday=new ArrayList<String>();
		programFridayHour=new ArrayList<String>();
	...
	/*public static void getInfoGrill(JSONObject json){
		...
		try {
			programmation= new SparseArray<ArrayList<String>>(); 
			programmationHour= new SparseArray<ArrayList<String>>();
			...
			for(int i=0;i<jarray.length();i++){
				...
				for(int j=0;j<jarrayDay.length();j++){
					...
					listHour.add(jObj.getString("start_time"));
				}
