...
/**
 * SplashFragment es el fragmento para realizar el login con kaltura mientas muestra el splash
 * @author Triolabs
...
public class SplashFragment extends Fragment {
	...
	static SplashFragment self;//contexto
	
	
	/** Se crea una instancia de SplashFragment se incializa self 
 	 */
     ...
     * se manda llamar al metodo de postDelayed
     */
	@Override
	...
	/**
     * Metodo postDelayed es un handler que atrasa 3 segundos para ejecutar 
     * el login de kaltura
     */
	...
	/**
     * Metodo changeViewMain despues de ejecutar el ansyctask de login de kaltura 
     * regresa a este metodo para mandar a pedir la parrilla de los programas
     */
