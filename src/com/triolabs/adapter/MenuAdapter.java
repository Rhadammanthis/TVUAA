...
public class MenuAdapter extends BaseAdapter {
	...
	Context context;
	String[] options;
	int[] imageOptions={R.drawable.tvonline,R.drawable.tv,R.drawable.alfa,R.drawable.calendario,R.drawable.menu_parrilla,R.drawable.contacto,R.drawable.salir};
	boolean contact;
